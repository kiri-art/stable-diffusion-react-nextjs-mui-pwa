    ...
    return (
      <Html lang={locale} dir={dir} style={{ height: "100%" }}>
        <Head>
          ...
          <meta name="twitter:card" content="Diffusion Image Generation" />
          <meta name="twitter:url" content="https://kiri.art" />
          <meta name="twitter:title" content="Kiri Art" />
          <meta
          ...
          <meta
            name="twitter:image"
            content="https://kiri.art/icons/android-chrome-192x192.png"
          />
          <meta name="twitter:creator" content="@gadicc" />
          <meta property="og:type" content="website" />
          <meta property="og:title" content="Kiri.Art" />
          <meta
            property="og:description"
            content="Diffusion Image Generation"
          />
          <meta property="og:site_name" content="Kiri.Art" />
          <meta property="og:url" content="https://kiri.art/" />
          <meta
            property="og:image"
            content="https://kiri.art/icons/apple-touch-icon.png"
          />
        </Head>
        <body>
          <Main />
